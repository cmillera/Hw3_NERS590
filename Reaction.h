...
class reaction {
  private:
    std::shared_ptr< distribution<double> > rxn_xs;
  protected:
    std::string rxn_name;
  public:
     reaction( std::shared_ptr< distribution<double> > x ) : rxn_xs(x) {};
    ~reaction() {};

    virtual std::string name() final { return rxn_name; };
    virtual std::shared_ptr< distribution<double> > xs(particle* p) final { return rxn_xs; };
...
class capture_reaction : public reaction {
  ...
  public:
     capture_reaction( std::shared_ptr< distribution<double> > x ) : reaction(x) { rxn_name = "capture"; };
    ~capture_reaction() {};
...
class scatter_reaction : public reaction {
  ...
  public:
     scatter_reaction( std::shared_ptr< distribution<double> > x, std::shared_ptr< distribution<double> > D ) :
...
class fission_reaction : public reaction {
  ...
  public:
     fission_reaction( std::shared_ptr< distribution<double> > x, std::shared_ptr< distribution<int> > D ) :
